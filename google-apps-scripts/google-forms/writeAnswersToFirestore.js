...
function onSubmit(e) {
	const testSubmissionEndpoint = "<CLOUD FUNCTION ENDPOINT>";

	const data = {
		simpleKey: '<SHARED SECRET>',
		exercise: '<camel cased version of name - can be shortened, UNIQUE TO EXERCISE>',
		phase: '<ONE OF situationJudgementStart, situationalJudgementFinsh, criticalAnalysisStart, criticalAnalysisFinish>'
	...
	itemResponses.forEach(function (itemResponse) {
		...
		// Leave this alone, it's a constant, not a variable that needs to be configured.
	...
	console.info({ situtationalJudgementStart: data.email });
	return true;
}
